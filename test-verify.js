...
var events = {
    ...
    6: { choices: [{ text: "数学课", effect: { intelligence: 15, skill: "数学" }, result: "数学" }, { text: "语文课", effect: { intelligence: 10, skill: "语文" }, result: "语文" }, { text: "体育课", effect: { health: 15, skill: "运动" }, result: "体育" }, { text: "音乐课", effect: { charm: 10, skill: "音乐" }, result: "音乐" }]},
    ...
    35: { choices: [{ text: "买学区房", effect: { money: -50000, fame: 10 }, result: "买房" }, { text: "保持现状", effect: { health: 10, relationship: 10 }, result: "保持" }, { text: "发展副业", effect: { money: 20000, health: -10, skill: "副业" }, result: "副业" }, { text: "投资理财", effect: { money: 10000, skill: "投资" }, result: "投资" }]},
    ...
    50: { choices: [{ text: "分享经验", effect: { fame: 20 }, result: "分享" }, { text: "享受生活", effect: { health: 15, money: -10000 }, result: "享受" }, { text: "投身慈善", effect: { fame: 25, money: -20000 }, result: "慈善" }, { text: "继续奋斗", effect: { money: 30000, health: -10 }, result: "奋斗" }]},
...
while (gameState.age < 65) {
    ...
    if (validChoices.length === 0) {
        console.log("❌ 年龄 " + gameState.age + ": 没有有效选项！");
        break;
    }
    ...
    if (gameState.health <= 0) {
        console.log("💀 年龄 " + gameState.age + ": 健康耗尽！");
        break;
    }
    if (gameState.money < -50000) {
        console.log("💸 年龄 " + gameState.age + ": 负债过多！");
        break;
    }
    ...
    if (oldAge === 0 || oldAge === 3 || oldAge === 6 || oldAge === 9 || oldAge === 12 || 
        ...
        console.log("✅ " + oldAge + " → " + gameState.age + "岁: " + choice.text + " | 健康:" + gameState.health + " 金钱:¥" + gameState.money);
    }
}
